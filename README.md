<div align="center">
  <img src="https://capsule-render.vercel.app/render?type=waving&color=00d2ff&height=200&section=header&text=Rajeev%20Kumar&fontSize=70&animation=fadeIn&fontAlignY=35&desc=Data%20Scientist%20|%20ML%20Engineer&descAlignY=60&descSize=25" width="100%"/>

  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=24&duration=3000&pause=1000&color=50C878&center=true&vCenter=true&width=700&lines=Hi+👋+I'm+Rajeev+Kumar;3rd-Year+CS+%26+Data+Analytics+@+IIT+Patna;Aspiring+Data+Scientist+%7C+ML+Engineer;I+Build+Models+That+Solve+Real+Problems" />
</div>
  ...
  <tr>
    <td width="50%">
      ...
      <ul>
        ...
        <li>🤖 Expert in <b>ML, Deep Learning & NLP</b></li>
        <li>🚀 Building projects & sharing insights from <b>IIT Patna</b></li>
...
| :--- | :--- | :--- |
| 📊 **Churn Prediction** | End-to-end classification for business retention. | Scikit-learn, Pandas |
| 🎵 **Music Recommender** | Content-based filtering using TF-IDF. | NLP, Cosine Similarity |
| 📉 **Attrition Estimator** | Cost-impact analysis via regression modeling. | Python, StatsModels |
| 📈 **Sales Dashboard** | Interactive EDA for business intelligence. | Streamlit, Plotly |
